...
### Visual do Wireframe
<img src="rascunho dashboard quantitativo.png"></img>
...
    * Chart.js (v4+): Biblioteca principal para renderização dos gráficos de Velocímetro (Doughnut), Colunas (Bar) e Histórico (Line).
...
* **Finalidade:** 
    * Estrutura Base HTML: A IA foi utilizada para gerar uma estrutura base dentro do html para organizar os elementos necessários para criação do dashboard.
